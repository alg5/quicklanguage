...
$lang = array_merge($lang, array(
	...
	'ACP_QUICK_LANGUAGE_ALLOW_GUESTS_EXPLAIN'	=> 'Тази настройка позволява на госта смяната на езика.При посещение без вписване ще се инсталират бисквитки на посетителския компютър, за да се определи език при следващото посещение.',
