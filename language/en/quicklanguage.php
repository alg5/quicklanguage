...
// You must use the language file that interests you. if your forum is English, you use the French language file, or Spanish, etc ..
// 	'FORUM_NAME_1'	=> 'Forum name having the id number 1',
// 	'FORUM_DESC_1'	=> 'Description forum having the id number 1',
// 	'FORUM_NAME_8'	=> 'Forum name having the id number 8',
// 	'FORUM_DESC_8'	=> 'Forum description having the id number 8',
// 	'FORUM_NAME_9'	=> 'Forum name having the id number 9',
